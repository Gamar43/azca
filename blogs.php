...
">
        <div class="container">
          <div class="border-bottom border-dark py-7">
            <p class="text-dark text-center fs-1">NEWS</p>
            ...
            <div class="row align-items-center gx-xl-7">
              <div class="col-lg-6 text-center"><img class="img-fluid" src="assets/img/blog/blog-hero.png" alt="" /></div>
      ...
      <section class="py-0">
        <div class="container">
          <h1 class="fs-lg-6 fs-md-5 fs-3">Latest News</h1>
          <div class="row mt-5 gx-xl-7">
            <div class="col-lg-4 col-md-6 mb-5 mb-md-0 text-center text-md-start h-auto">
              <div class="d-flex justify-content-between flex-column h-100"><img class="w-md-100 w-75 rounded-2" src="assets/img/blog/1.png" alt="" />
                ...
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3 mb-md-5"><img class="img-fluid" src="assets/img/blog/profile1.png" alt="" />
