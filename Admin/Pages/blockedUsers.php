     ...
     <ul class="nav sidebar-nav">
       ...
       <div class="sidebar-brand">
        ...
        <div class="container">
          ...
          <tr class="table-danger" data-bs-toggle="modal" data-bs-target="#exampleModalFullscreen2">
...
<!-- -------------------------side bar--------------------------- -->
                  ...
                  <div class="card h-100">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3">Actions : </h6>
                       ...
                       <a href="#DeleteAccountModal" class="btn btn-danger mt-3" data-bs-toggle="modal" data-bs-target="#DeleteAccountModal"> Delete Account</a>


                       <a href="#BlockModal" class="btn btn-danger mt-3" data-bs-toggle="modal" data-bs-target="#BlockModal"> Unblock User</a>
 ...
 <div class="modal fade" id="BlockModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Unblock User?</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <!-- -----------------------------------block modal body------------------------ -->
      <div class="modal-body">
        User will be able to access his account ,Unblock user?
      </div>
      <!-- -----------------------------------block modal body------------------------ -->
      <div class="modal-footer">
        <button class="btn btn-secondary" data-bs-target="#exampleModalFullscreen2" data-bs-toggle="modal">Back</button>
