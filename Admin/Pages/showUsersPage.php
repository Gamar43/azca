     ...
     <ul class="nav sidebar-nav">
       ...
       <div class="sidebar-brand">
        ...
        <div class="container">
          ...
          <tr class="table-light" data-bs-toggle="modal" data-bs-target="#exampleModalFullscreen2">
...
<!-- ------------------------------------------------------------Modals---------------------------------------------------------------- -->
          ...
          <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
            <div class="modal-content">
             <div class="modal-header">
              <h1 class="modal-title fs-4" id="exampleModalFullscreenLabel">user info</h1>
                  ...
                  <div class="card h-100">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3">Actions : </h6>
                       ...
                       <a href="#BlockModal" class="btn btn-primary mt-3" data-bs-toggle="modal" data-bs-target="#BlockModal"> Block User</a>
 ...
 <div class="modal fade" id="sendNoteModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Send Note to this user</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
